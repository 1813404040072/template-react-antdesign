...
class Datatable extends BaseComponent {
  ...
  render() {
    const { datatable, loading, match } = this.props;
      ...
      <Layout className="full-layout page datatable-page">
        <Content>
          <Panel title={intl.formatMessage(messagesBaseComponent.description)}>
            ...
            <p>
              {intl.formatMessage(messages.dataTableCombines) + ' '}
              <Link
                to={routerLinks['WidgetsColumns'].replace(routerLinks['TypeRouter'], `/${match.params.type}/`)}
              >
